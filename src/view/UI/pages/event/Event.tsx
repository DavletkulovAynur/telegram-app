  ...
  return (
    <div className={css.container}>
      ...
      <div className={css.content}>
        ...
        <h1>Живописные маршруты и единение с природой</h1>
        <p>
          На этих выходных у вас есть уникальная возможность провести время
          незабываемо. Вы можете посетить живописные уголки природы, где каждая
          деталь наполнена красотой и спокойствием. Представьте себе прогулку
          верхом на лошадях по удивительным маршрутам, где лесные тропы
          сменяются полями с цветущими лугами. Этот опыт подарит вам чувство
          свободы и гармонии с природой.
        </p>
