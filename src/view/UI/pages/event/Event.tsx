      ...
      <div className={css.content}>
        ...
        <div className={css.descriptionWrap}>
          ...
          <p>
            ...
            незабываемо. Вы можете посетить живописные уголки природы, где
            каждая деталь наполнена красотой и спокойствием. Представьте себе
            прогулку верхом на лошадях по удивительным маршрутам, где лесные
            тропы сменяются полями с цветущими лугами. Этот опыт подарит вам
            чувство свободы и гармонии с природой.
          </p>
          7 929 579 77 80
          <iframe
